...
>(({ className, ...props }, ref) => {
  ...
  return (
    <CheckboxPrimitive.Root
      ref={ref}
      className={cn(
        "peer h-4 w-4 shrink-0 bg-gs-blue  disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:border-2 data-[state=checked]:border-gs-gray data-[state=checked]:text-transparent",
        isHovering
